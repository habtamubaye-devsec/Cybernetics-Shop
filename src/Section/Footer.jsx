...
const Footer = () => {
  ...
  return (
    <div id='contact' className='w-full flex flex-col justify-center items-center'>
      ...
      <div data-aos="zoom-in" data-aos-delay="100" className='w-full bg-purple-700 lg:px-20 px-10 py-8 grid lg:grid-cols-6 grid-cols-2 justify-center items-center gap-10'>
      ...
      <div className='w-full lg:px-20 py-[60px] bg-gray-100 grid lg:grid-cols-5 grid-cols-1 justify-center items-start lg:gap-3 gap-10'>
        <div data-aos="zoom-in" data-aos-delay="200" className='flex flex-col justify-center items-start gap-10 grow'>
          <div className='flex flex-col justify-center items-start gap-4'>
            <h1 className='text-4xl font-bold text-purple-700 underline'>Electra Shop</h1>
            <p className='text-gray-500 text-justify'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vitae totam porro veritatis
              repellendus voluptatem aspernatur doloremque, tempora, numquam aut omnis repellat
              quisquam illum, libero iure animi nemo. Voluptas, sapiente nemo.</p>
          </div>
      ...
      <div className='w-full lg:px-20 px-5 py-[40px] bg-gray-100'>
        ...
        <div className='w-full flex lg:flex-row flex-col justify-center items-center lg:gap-4 gap-6'>
          ...
          <div className='lg:w-[60%] w-full flex lg:flex-row flex-col justify-center items-center gap-4 flex-grow'>
            ...
            <div>
              ...
              <button className='bg-purple-700 lg:w-auto w-full text-white hover:bg-yellow-300 hover:text-black px-6 py-3 rounded-r-lg font-semibold'>SUBMIT</button>
            </div>
          </div>
          <div className='lg:w-[20%] w-full'>
            <p className='text-gray-400 lg:text-end text-center'>2024 Powered by @ABIBAYE</p>
          </div>
        </div>
      </div>
      {/* scroll to top */}
      <div className=' bg-purple-700 text-white p-3 rounded-full hover:bg-yellow-300 hover:text-black cursor-pointer fixed  lg:bottom-6 right-6 bottom-6'>
