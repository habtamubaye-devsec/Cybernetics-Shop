  ...
  return (
    <div className='w-full lg:px-20 px-5 py-[80px] grid lg:grid-cols-3 grid-cols-1 justify-center items-center gap-10'>
      <div data-aos="zoom-in" data-aos-delay="100" className='flex flex-col justify-center items-end gap-6 bg-cover bg-center p-10 rounded-lg' style={{ backgroundImage: `url(${banner1})` }}>
        <h1 className='text-yellow-300 border rounded-lg border-yellow-300 px-6 py2 text-lg'>60% Off</h1>
        <h1 className='text-4xl text-end text-white font-semibold'>Wireless <br /> Device</h1>
      ...
      <div data-aos="zoom-in" data-aos-delay="100" className='flex flex-col justify-center items-end gap-6 bg-cover bg-center p-10 rounded-lg' style={{ backgroundImage: `url(${banner2})` }}>
        <h1 className='text-yellow-300 border rounded-lg border-yellow-300 px-6 py2 text-lg'>60% Off</h1>
        <h1 className='text-4xl text-end text-white font-semibold'>Wired <br /> Earphone</h1>
        <button className='bg-yellow-300 px-6 py-3 rounded-lg text-black font-semibold'>SHOP NOW</button>
      </div>
